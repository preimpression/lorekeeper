...
@section('admin-title') Add Item Tag @endsection

@section('admin-content')
{!! breadcrumbs(['Admin Panel' => 'admin', 'Items' => 'admin/data/items', 'Edit '. $item->name  => 'admin/data/items/edit/'.$item->id, 'Add Item Tag' => 'admin/data/items/tag/'.$item->id]) !!}
