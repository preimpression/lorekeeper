...
{!! breadcrumbs(['Admin Panel' => 'admin', 'Items' => 'admin/data/items', 'Edit '. $item->name => 'admin/data/items/edit/'.$item->id, 'Edit Tag Settings - ' . $tag->tag => 'admin/data/items/tag/'.$item->id.'/'.$tag->tag]) !!}
